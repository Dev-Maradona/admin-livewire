				...
				<div class="col-md-4 col-xl-3">
					<div class="card mb-3">
						...
						<div class="card-body text-center">
							<img src="{{asset('admin/img/avatars/avatar-4.jpg')}}" alt="Christina
								Mason" class="img-fluid rounded-circle mb-2" width="128" height="128"
								/>
						...
						<div class="card-body">
							...
							<ul class="list-unstyled mb-0">
								...
								<li class="mb-1"><span data-feather="briefcase" class="feather-sm
										me-1"></span> Works at <a href="#">GitHub</a></li>
								<li class="mb-1"><span data-feather="map-pin" class="feather-sm
										me-1"></span> From <a href="#">Boston</a></li>
							</ul>
						</div>
						<hr class="my-0" />
						<div class="card-body">
					...
					<div class="card">
						...
						<div class="card-body h-100">
							...
							<div class="d-flex align-items-start">
								<img src="{{asset('admin/img/avatars/avatar-5.jpg')}}" width="36"
							...
							<hr />
							<div class="d-flex align-items-start">
								<img src={{asset('admin/img/avatars/avatar.jpg')}} width="36" height="36"
							...
							<hr />
							<div class="d-flex align-items-start">
								<img src="{{asset('admin/img/avatars/avatar-4.jpg')}}" width="36"
							...
							<hr />
							<div class="d-flex align-items-start">
								<img src="{{asset('admin/img/avatars/avatar-2.jpg')}}" width="36"
								...
								<div class="flex-grow-1">
									...
									<div class="row g-0 mt-1">
										<div class="col-6 col-md-4 col-lg-4 col-xl-3">
											<img src="{{asset('admin/img/photos/unsplash-1.jpg')}}" class="img-fluid pe-2"
												alt="Unsplash">
										</div>
										<div class="col-6 col-md-4 col-lg-4 col-xl-3">
											<img src="{{asset('admin/img/photos/unsplash-2.jpg')}}" class="img-fluid pe-2"
												alt="Unsplash">
										</div>
									</div>
							...
							<hr />
							<div class="d-flex align-items-start">
								<img src="{{asset('admin/img/avatars/avatar-2.jpg')}}" width="36" height="36"
								...
								<div class="flex-grow-1">
									...
									<div class="d-flex align-items-start mt-1">
										<a class="pe-3" href="#">
											<img src="{{asset('admin/img/avatars/avatar-4.jpg')}}" width="36" height="36"
