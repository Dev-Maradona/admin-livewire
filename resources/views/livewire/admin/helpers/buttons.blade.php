...
@section('title', 'Buttons | Dashboard')
				...
				<div class="col-12 col-lg-6">
					<div class="card">
						...
						<div class="card-body">
							...
							<br>
							<div class="btn-group mb-3" role="group" aria-label="Default button
								group">
								<button type="button" class="btn btn-secondary">Left</button>
								<button type="button" class="btn btn-secondary">Middle</button>
								<button type="button" class="btn btn-secondary">Right</button>
							...
							<div class="btn-toolbar mb-4" role="toolbar" aria-label="Toolbar with
								button groups">
