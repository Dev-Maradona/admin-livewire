		...
		<div class="container-fluid p-0">
			...
			<div class="row">
				<div class="col-12 col-md-6">
					<div class="card">
						<img class="card-img-top" src="{{asset('admin/img/photos/unsplash-1.jpg')}}"
							alt="Unsplash">
				...
				<div class="col-12 col-md-6">
					<div class="card">
						<img class="card-img-top" src="{{asset('admin/img/photos/unsplash-2.jpg')}}"
							alt="Unsplash">
						<div class="card-header">
